...
//
//If using a Knock-off Arduino Nano. Install the board drivers and the set `Change Tools > Processor > old bootloader`
...
int displayTimer = 10; //Timer for the display timeout
...
void loop() {
  ...
  if (button1State == HIGH) {
    ...
    displayTimer = 10;  // Reset displayTimer on button press
    button1Toggle = 1;
  } else {
    button1Toggle = 0;
  }
